...
#ifndef GUARD_SMCPCORE_BEDROCK_CONFIG_DETAILS_BASICCONSTANTS_H
#define GUARD_SMCPCORE_BEDROCK_CONFIG_DETAILS_BASICCONSTANTS_H
#pragma once
...
#endif // GUARD_SMCPCORE_BEDROCK_CONFIG_DETAILS_BASICCONSTANTS_H
